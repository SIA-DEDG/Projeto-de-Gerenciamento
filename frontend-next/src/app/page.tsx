...
function KanbanCard({
  ...
  return (
    ...
    >
      ...
      <div className="card-content" onClick={() => !isDragging && onEdit(task)}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '8px' }}>
          ...
          <button
            ...
            style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#a1aeb7', fontSize: '1.1rem', lineHeight: 1, flexShrink: 0 }}
          >
            &times;
          </button>
        </div>
      ...
      <div className="card-footer" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '10px' }}>
        <span style={{ fontSize: '0.7rem', color: '#6b778c' }}>SIA-{task.id}</span>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontSize: '0.75rem', color: '#6b778c' }}>{task.date}</span>
          <div
